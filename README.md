...
Е) Вывод: поскольку AntConc все самостоятельно выбранные и скачанные мной файлы в формате txt (вне зависимости от кодировки) открывать отказывался, возможности сопоставить текст Толстого с каким-либо другим у меня не было, так что c'est tout :(
